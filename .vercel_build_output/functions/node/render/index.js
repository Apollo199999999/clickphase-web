...
// .svelte-kit/output/server/chunks/index-f5fc5b86.js
function noop2() {
}
function run(fn) {
  return fn();
...
// .svelte-kit/output/server/chunks/NavigationView.svelte_svelte_type_style_lang-7ffe035b.js
var css, TextBlock;
var init_NavigationView_svelte_svelte_type_style_lang_7ffe035b = __esm({
  ".svelte-kit/output/server/chunks/NavigationView.svelte_svelte_type_style_lang-7ffe035b.js"() {
    init_index_f5fc5b86();
    css = {
...
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/__layout.svelte.js"() {
    init_index_f5fc5b86();
    init_NavigationView_svelte_svelte_type_style_lang_7ffe035b();
    getStores = () => {
    ...
    css$1 = {
      code: '@font-face{font-family:"FluentUIIcons";src:url("/FluentSystemIcons-Regular.ttf")}.active.svelte-1nyxucw a.svelte-1nyxucw{background-color:var(--fds-accent-default) !important;color:var(--fds-text-on-accent-primary) !important}header.svelte-1nyxucw.svelte-1nyxucw{position:sticky;top:0;z-index:2147483647;display:flex;overflow:auto;background-color:var(--fds-control-solid-fill-default)}@supports (-webkit-backdrop-filter: blur(60px) saturate(200%)) or\n		(backdrop-filter: blur(60px) saturate(200%)){header.svelte-1nyxucw.svelte-1nyxucw{position:sticky;top:0;z-index:2147483647;display:flex;overflow:auto;background-color:var(--fds-control-fill-default);backdrop-filter:blur(60px) saturate(200%);-webkit-backdrop-filter:blur(60px) saturate(200%)}}.corner.svelte-1nyxucw.svelte-1nyxucw{height:4em}.corner.svelte-1nyxucw a.svelte-1nyxucw{display:flex;align-items:center;justify-content:center;width:100%;height:100%;text-decoration:none;color:inherit;margin-right:3em}.corner.svelte-1nyxucw img.svelte-1nyxucw{width:2.5em;height:2.5em;object-fit:contain;margin-right:0.5em}nav.svelte-1nyxucw.svelte-1nyxucw{display:flex;justify-content:center;margin-left:1em}ul.svelte-1nyxucw.svelte-1nyxucw{position:relative;padding:0;margin:auto;display:flex;justify-content:center;align-items:center;list-style:none;background-size:contain}li.svelte-1nyxucw.svelte-1nyxucw{position:relative;height:100%;margin-right:0.5em}li.svelte-1nyxucw a.svelte-1nyxucw{padding:5px 11px 5px 7px;border-radius:var(--fds-control-corner-radius);text-decoration:none;font-family:var(--fds-font-family-display);display:flex;color:var(--fds-text-secondary)}li.svelte-1nyxucw a.svelte-1nyxucw:hover{color:var(--fds-accent-text-primary);background-color:var(--fds-card-background-secondary)}.linkIcon.svelte-1nyxucw.svelte-1nyxucw{font-family:"FluentUIIcons";font-size:20px;margin:auto;margin-right:0.3em}.linkText.svelte-1nyxucw.svelte-1nyxucw{margin:auto;line-height:100%}',
      map: null
    };
...
<header class="${"svelte-1nyxucw"}"><div class="${"corner svelte-1nyxucw"}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-1nyxucw"}"><img src="${"/logo-img.png"}" alt="${"ClickPhase"}" class="${"svelte-1nyxucw"}">
	...
	<nav class="${"svelte-1nyxucw"}"><ul class="${"svelte-1nyxucw"}"><li class="${["svelte-1nyxucw", $page.url.pathname === "/" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-1nyxucw"}"><p class="${"linkIcon svelte-1nyxucw"}">\uF480</p>
					<p class="${"linkText svelte-1nyxucw"}">Home</p></a></li>
			<li class="${["svelte-1nyxucw", $page.url.pathname === "/software" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/software"}" class="${"svelte-1nyxucw"}"><p class="${"linkIcon svelte-1nyxucw"}">\u02A7</p>
					<p class="${"linkText svelte-1nyxucw"}">Software</p></a></li>
			<li class="${[
        "svelte-1nyxucw",
        $page.url.pathname === "/animationsvideos" ? "active" : ""
      ].join(" ").trim()}"><a sveltekit:prefetch href="${"/animationsvideos"}" class="${"svelte-1nyxucw"}"><p class="${"linkIcon svelte-1nyxucw"}">\u0378</p>
					<p class="${"linkText svelte-1nyxucw"}">Animations/Videos</p></a></li>
			<li class="${["svelte-1nyxucw", $page.url.pathname === "/aboutcontact" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/aboutcontact"}" class="${"svelte-1nyxucw"}"><p class="${"linkIcon svelte-1nyxucw"}">\uF4A3</p>
					<p class="${"linkText svelte-1nyxucw"}">About/Contact</p></a></li></ul></nav>

	<div class="${"corner svelte-1nyxucw"}"></div>
</header>`;
    });
    css2 = {
      code: "body{background-color:var(--fds-solid-background-base);color:var(--fds-text-primary);margin:0%;padding:0%}main.svelte-g7evcu{flex:1;display:flex;flex-direction:column;width:100%;margin:0, auto;padding:0%;box-sizing:border-box;overflow-x:hidden}",
      map: null
    };
...
<main class="${"svelte-g7evcu"}">${slots.default ? slots.default({}) : ``}
</main>`;
    });
  }
});
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    init_layout_svelte();
    entry = "pages/__layout.svelte-5ae346ff.js";
    js = ["pages/__layout.svelte-5ae346ff.js", "chunks/index-b6d12f89.js", "chunks/NavigationView.svelte_svelte_type_style_lang-bca745cd.js"];
    css3 = ["assets/pages/__layout.svelte-8a072537.css", "assets/NavigationView.svelte_svelte_type_style_lang-7136ff2f.css"];
  }
});
  ...
  return (node) => {
    ...
    return {
      destroy: () => {
        ...
        for (let entry3 of Object.entries(forwardDestructors)) {
          entry3[1]();
        }
      }
    };
...
${href && !disabled ? `<a${spread([
    ...
    css4 = {
      code: '.container.svelte-c3j4tz{position:relative;word-wrap:break-word;align-items:center;justify-content:center;text-align:center}.components.svelte-c3j4tz{position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);text-align:center}.error-status.svelte-c3j4tz{line-height:normal}.error-message.svelte-c3j4tz{margin-top:1rem;line-height:normal}.error-button.svelte-c3j4tz{transform:scale(1.1);margin-top:calc(1.5rem * 1.1)}.mica-bg.svelte-c3j4tz{position:relative;width:100%;height:calc(100vh - 4em);overflow:hidden}.image.svelte-c3j4tz{background-image:url("/MicaLight.png");width:100%;height:100%;filter:saturate(120%);transform:scale(1.7);background-position:center;background-repeat:no-repeat;background-size:cover;background-attachment:fixed}@media(prefers-color-scheme: dark){.image.svelte-c3j4tz{background-image:url("/MicaDark.png");width:100%;height:100%;filter:saturate(120%);transform:scale(1.7);background-position:center;background-repeat:no-repeat;background-size:cover;background-attachment:fixed}}.image.svelte-c3j4tz:before{content:"";position:absolute;left:0;right:0;top:0;bottom:0;background:var(--fds-card-background-secondary)}',
      map: null
    };
    _error = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$result.css.add(css4);
      return `
<div class="${"container svelte-c3j4tz"}"><div class="${"mica-bg svelte-c3j4tz"}"><div class="${"image svelte-c3j4tz"}"></div></div>
    <div class="${"components svelte-c3j4tz"}"><div class="${"error-status svelte-c3j4tz"}">${validate_component(TextBlock, "TextBlock").$$render($$result, { variant: "display" }, {}, {
        default: () => {
          return `Error ${escape(status)}`;
        }
      })}</div>
        <div class="${"error-message svelte-c3j4tz"}">${validate_component(TextBlock, "TextBlock").$$render($$result, { variant: "bodyLarge" }, {}, {
        default: () => {
          return `Error message: ${escape(message)}`;
        }
      })}</div>
        <div class="${"error-button svelte-c3j4tz"}">${validate_component(Button, "Button").$$render($$result, { href: "/" }, {}, {
        default: () => {
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    init_error_svelte();
    entry2 = "pages/__error.svelte-425d2417.js";
    js2 = ["pages/__error.svelte-425d2417.js", "chunks/index-b6d12f89.js", "chunks/NavigationView.svelte_svelte_type_style_lang-bca745cd.js"];
    css5 = ["assets/pages/__error.svelte-b3caadf6.css", "assets/NavigationView.svelte_svelte_type_style_lang-7136ff2f.css"];
  }
});
...
var manifest = {
  appDir: "_app",
  assets: /* @__PURE__ */ new Set(["FluentSystemIcons-Regular.ttf", "MicaDark.png", "MicaLight.png", "app-images/dynawin/DynaWinImage.jpg", "app-images/dynawin/logoDark.png", "app-images/dynawin/logoLight.png", "app-images/grannykeyboard/GrannyKeyboardImage.png", "app-images/launcherx/LauncherXImage.png", "favicon.ico", "logo-img.png", "screenshots/dynawin/WindowDark.png", "screenshots/dynawin/WindowLight.png", "youtube-profiles/clickphase.png", "youtube-profiles/granny.png", "youtube-profiles/matthias-wang.jpg"]),
  mimeTypes: { ".ttf": "font/ttf", ".png": "image/png", ".jpg": "image/jpeg", ".ico": "image/vnd.microsoft.icon" },
  _: {
    entry: { "file": "start-6460bc2b.js", "js": ["start-6460bc2b.js", "chunks/index-b6d12f89.js"], "css": [] },
    nodes: [
