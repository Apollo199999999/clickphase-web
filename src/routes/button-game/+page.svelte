<script>
  ...
  import AboutButtonGame from "../../sections/button-game/AboutButtonGame.svelte";
  import Links from "/src/sections/button-game/Links.svelte";
</script>
...
<SvelteSeo
  title="Button Game - ClickPhase"
  description="A simple idle button game written in p5.js."
  ...
  canonical="https://clickphase.vercel.app/button-game"
  openGraph={{
    title: "Button Game - ClickPhase",
    description:
      "A simple idle button game written in p5.js.",
    url: "https://clickphase.vercel.app/button-game",
    type: "website",
    images: [
      {
        url: "https://clickphase.vercel.app/open-graph-images/ButtonGameImage.png",
        width: 1200,
        height: 630,
        alt: "Button Game - ClickPhase",
      },
    ],
  }} />
