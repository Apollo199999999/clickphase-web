<script>
  ...
  import AboutYoureTheServer from "../../sections/youre-the-server/AboutYoureTheServer.svelte";
  import Links from "/src/sections/youre-the-server/Links.svelte";
</script>
...
<SvelteSeo
  title="You're the Server! - ClickPhase"
  description="A game where you are a chat server, managing client connections and messages."
  ...
  canonical="https://clickphase.vercel.app/youre-the-server"
  openGraph={{
    title: "You're the Server! - ClickPhase",
    description:
      "A game where you are a chat server, managing client connections and messages.",
    url: "https://clickphase.vercel.app/youre-the-server",
    type: "website",
    images: [
      {
        url: "https://clickphase.vercel.app/open-graph-images/YoureTheServerImage.png",
        width: 1200,
        height: 630,
        alt: "You're the Server! - ClickPhase",
      },
    ],
  }} />
